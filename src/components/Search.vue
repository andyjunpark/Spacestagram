...
<html>
  <div class="search">
    <h2 id="spacetagram"><a><img src="../assets/spacestagram.png" alt="Lettering fonts" style="width:400px;"></a></h2>
    <h4 style="color:white; opacity:80%">Get HD Images Directly from NASA</h4>
  <!-- Search Button -->
...
html {
  overflow:hidden;
  min-height:1500px;
  background: radial-gradient(ellipse at bottom, #08134d 0%, black 100%); 
}
